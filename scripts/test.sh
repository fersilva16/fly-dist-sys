...
# maelstrom test -w broadcast --bin ./build/fly-dist-sys --node-count 5 --time-limit 20 --rate 10
maelstrom test -w broadcast --bin ./build/fly-dist-sys --node-count 5 --time-limit 20 --rate 10 --nemesis partition
